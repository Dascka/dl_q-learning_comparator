                        ...
                        for batch_size in batch_sizes:
                            for max_step in max_steps:
                                for warmup in warmups:
                                    ...
                                    ep_avgx_mean_plot(returns, False, title, path, False, ylim, True, repeat, stop_cond, win_cond, xlim = [0, 400])
                                    ...
                                    ep_avgx_mean_plot(returns, False, title, path, True, ylim, True, repeat, stop_cond, win_cond, xlim = [0, 400])
